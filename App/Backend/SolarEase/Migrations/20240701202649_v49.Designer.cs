...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.ChatbotMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.FAQMessage", b =>
                {
                    b.Property<int>("PersonId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.FAQMessage", b =>
                {
                    b.HasOne("SolarEase.Models.Domain.FAQ", "FAQ")
                        .WithMany("FAQHistoryMessages")
                        .HasForeignKey("FAQId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SolarEase.Models.Domain.Person", "Person")
                        .WithMany("FAQMessages")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.FAQ", b =>
                {
                    b.Navigation("FAQHistoryMessages");
                });
