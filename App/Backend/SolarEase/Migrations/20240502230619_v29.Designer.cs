...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.Calculator", b =>
                {
                    ...
                    b.Property<string>("NumofBatteries")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TotalCostStr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.ElectricityTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ElectricityTariffs");
                });

            modelBuilder.Entity("SolarEase.Models.Domain.ElectricityTariffSubrange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ElectricityTariffId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ElectricityTariffId");

                    b.ToTable("ElectricityTariffSubranges");
                });
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.ElectricityTariffSubrange", b =>
                {
                    b.HasOne("SolarEase.Models.Domain.ElectricityTariff", "ElectricityTariff")
                        .WithMany("ElectricityTariffSubranges")
                        .HasForeignKey("ElectricityTariffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolarEase.Models.Domain.ElectricityTariff", b =>
                {
                    b.Navigation("ElectricityTariffSubranges");
                });
